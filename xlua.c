...
extern int64_t tolua_toint64(lua_State* L, int pos);
extern int64_t tolua_touint64(lua_State* L, int pos);
extern void tolua_pushint64(lua_State* L, int64_t n);
extern void tolua_pushuint64(lua_State* L, int64_t n);
...
DIRECT_ACCESS(int64_t, tolua_pushint64, tolua_toint64);
DIRECT_ACCESS(uint64_t, tolua_pushuint64, tolua_touint64);
